...
rname_map=(/ghi/fs01/belle2/bdata/Data/e0007/4S/Bucket6/release-03-01-02/DB00000618/r03128/skim/hlt_hadron/cdst/sub00/cdst.physics.0007.03128.HLT0.hlt_hadron.root
...
for namap in "${rname_map[@]}";do
       ...
       export OUTPUT='b0bp_psi2s_'${counter}'_buck6.root'
       bsub basf2 ./shou_b0bp_psi2s_real_recon_buck6.py
counter=$((counter+1))
done
