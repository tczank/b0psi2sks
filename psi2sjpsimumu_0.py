...
ma.inputMdst(environmentType='default',
             filename=b2.find_file('/home/thczank/b0psi2sks/gsim/psi2sjpsimumu/b0_psi2s_gsim_psi2sjpsimumu_all.root'),
             path=mypath)
...
rootOutputFile = "B0psi2Sjpsimumu_recon_ipprofile.root"
